        ...
        if(!TextUtils.isEmpty(Name2) && imguri != null)
        {
            ...
            filepath.putFile(imguri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    mdatabaseusers.child(District).child("Retailers").child(Name2).child("Postimage").setValue(downloadUri);

                    mprogress.dismiss();
                    Intent mainIntent = new Intent(SetupActivity1.this,RetailerActivity.class);
