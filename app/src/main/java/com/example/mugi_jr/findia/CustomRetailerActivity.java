...
public class CustomRetailerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_custom_retailer);
        ...
        selectedDistrict=getIntent().getExtras().getString("DistrictName");
        Log.e("SelectedDistritINCR",selectedDistrict);
        mdatabase = FirebaseDatabase.getInstance().getReference().child("Blog1").child(selectedDistrict);
        ...
        mauthlistner = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                if (firebaseAuth.getCurrentUser() == null) {
                    Intent loginIntent = new Intent(CustomRetailerActivity.this, LoginActivity.class);
   ...
   public boolean onCreateOptionsMenu(Menu menu) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.action_jpost) {
            startActivity(new Intent(CustomRetailerActivity.this, PostActivity.class));
        }
        ...
        if (item.getItemId() == R.id.action_settings) {
            startActivity(new Intent(CustomRetailerActivity.this, SetupActivity.class));
        }
